...
// Models
import { Indicator, IndicatorGroup, Months, RegistryType } from '../../../shared/models';
...
export class IndicatorDisplayComponent implements OnInit/* , OnChanges */ {
  ...
  gotoIndicator(idIndicatorGroup: number, idIndicator: number) {
    this.router.navigateByUrl('/indicador/' + idIndicatorGroup + '/' + idIndicator);
  }
