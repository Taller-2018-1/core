...
export class ReportgeneratorComponent implements OnInit {
  ...
  downloadExcel()
  {
    ...
    if(this.selectMonth.localeCompare("Ninguno")!=0)
    {
      ...
      var ws_data = [[' ','Reporte Indicadores '+this.selectedYear+ " " + this.selectMonth]];  //a row with 2 columns
    }
    else
    {
      var ws_data = [[' ','Reporte Indicadores '+this.selectedYear]]; 
    }
